...
class DebitPayment extends StatefulWidget {
  const DebitPayment({super.key});

  @override
  State<DebitPayment> createState() => _DebitPaymentState();
}

class _DebitPaymentState extends State<DebitPayment> {
  @override
  Timer? _timer;
  int _start = 59;
        ...
        child: _isTimeUp
            ...
            : Column(
                ...
                children: [
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                       Icon(Icons.payments_rounded, size: 100, color: Colors.green,),
